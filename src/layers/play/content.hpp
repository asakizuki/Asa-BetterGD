...
{
public:
    static void init(PlayLayer *self, GJGameLevel *lvl);
    ...
    static CCSprite *iconWithShipRenderer(ccColor3B color_1, ccColor3B color_2, int cube_id = 1, int ship_id = 1, bool hasGlow = false)
    {
        ...
        auto cube = PlayLayerInit::cubeRenderer(color_1, color_2, cube_id, hasGlow);
        auto ship = PlayLayerInit::shipRenderer(color_1, color_2, ship_id, hasGlow);
    ...
    static CCSprite *iconWithUFORenderer(ccColor3B color_1, ccColor3B color_2, int cube_id = 1, int ufo_id = 1, bool hasGlow = false)
    {
        ...
        auto cube = PlayLayerInit::cubeRenderer(color_1, color_2, cube_id, hasGlow);
        auto ufo = PlayLayerInit::ufoRenderer(color_1, color_2, ufo_id, hasGlow);
